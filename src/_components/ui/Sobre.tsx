                ...
                <motion.div
                    ...
                    <div className="lg:w-[700px] pr-9 lg:pr-0 md:w-[400px] flex flex-col mt-12  ml-10 text-[#979797]">
                        <p className="pb-4">
                            ...
                            utilizando Node.js, NestJS, SQL, PostgreSQL, Python, Laravel, MariaDB e Docker.
                        </p>
                        <p>
                    ...
                    <div className="pt-4 ml-10">
                        <p className="pr-4 lg:pr-0">Tecnologias:</p>
                        <div className="grid grid-cols-2 gap-x-4 lg:w-[450px] lg:gap-x-0">
                            ...
                            <ItensListaTec text="Laravel " />
                            <ItensListaTec text="NestJS " />
                            <ItensListaTec text="Python " />
                            <ItensListaTec text="MariaDB " />
                        </div>
                    </div>
                </motion.div>
                <motion.div
